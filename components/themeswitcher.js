const sunIcon = (
  ...
  const ThemeSwitcher = () => {
    return (
      <div className="flex justify-center p-1 mt-6 bg-white dark:bg-gray-900 rounded-xl">
        <button
          type="button"
          ...
          className="flex items-center justify-center w-24 h-10 p-2 pr-2 transition dark:bg-primary rounded-xl align-center"
        >
          {moonIcon}
        </button>
        ...
        <button
          ...
          className="flex items-center justify-center w-24 h-10 p-2 pr-2 transition bg-primary dark:bg-transparent rounded-xl align-center"
        >
          {sunIcon}
        </button>
      </div>
